                ...
                <form name="createForm" onSubmit={handleSubmit}>
                    <div className="flex flex-wrap p-8 -mb-8 -mr-6">
                        ...
                        >
                            ...
                            <option value="2" defaultValue={data.is_automeal}>No</option>
                        </SelectInput>
                        ...
                        >
                            ...
                            <option value="2" defaultValue={data.has_breakfast}>No</option>
                        </SelectInput>
                        ...
                        >
                            ...
                            <option value="2" defaultValue={data.has_lunch}>No</option>
                        </SelectInput>
                        ...
                        >
                            ...
                            <option value="2" defaultValue={data.has_dinner}>No</option>
                        </SelectInput>
...
Create.layout = (page) => <Layout title="Create Mess" children={page}/>;
