        ...
        <div
            ...
            <div
                ...
                <button onClick={handleModalClose}
                        className="absolute top-6 right-6 flex h-7 w-7 items-center justify-center rounded-full bg-primary/10 dark:bg-white text-black dark:text-black transition hover:bg-primary hover:text-white">
