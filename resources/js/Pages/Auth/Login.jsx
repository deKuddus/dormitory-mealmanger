...
export default () => {
    ...
    return (
        <>
            <Head title="Login"/>
            <div className="h-auto m-auto border border-stroke bg-white  dark:border-strokedark dark:bg-boxdark">
                <div
                    className='rounded-sm py-25 lg:py-17.5'>
                                ...
                                <form onSubmit={handleSubmit}>
                                    <div className='mb-4'>
                                        ...
                                        <div className='relative'>
                                          ...
                                          <svg
                                              className={`fill-current ${errors['password'] ? 'text-danger':''}`}
                                              width='22'
                                              height='22'
                                              viewBox='0 0 22 22'
                                              fill='none'
                                    ...
                                    <div className='mb-6'>
                                        <Checkbox name={'remember'} onChangeHandler={setData} label="Remember Me" isChecked={data.remember}/>
                                    </div>
