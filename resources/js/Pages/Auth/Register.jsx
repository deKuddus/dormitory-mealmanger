    ...
    return (
        < >
            <Head>
                ...
                <meta name="title" content="Registration::Dormefy"/>
                <meta property="og:title" content="Registration::Dormefy "/>
                <meta property="og:image" content="/ogimage.png"/>
            </Head>
            <div className="h-auto border border-stroke bg-white  dark:border-strokedark dark:bg-boxdark">
                <div
                    ...
                    <div className='flex flex-wrap items-center'>
                        ...
                        <div className='w-full border-stroke dark:border-strokedark xl:w-1/2 xl:border-l-2'>
                            <div className='w-full p-4 sm:p-12.5 xl:p-17.5'>
                                ...
                                {!validToken && (
                                    <h2 className='mb-9 text-danger text-xl  sm:text-title-xl2'>
                                ...
                                <form onSubmit={handleSubmit}>
                                    <div className='mb-4'>
                                        ...
                                        />
                                        {errors && <div className="text-danger p-2">{errors['full_name']}</div>}
                                    </div>
                                    <div className='mb-4'>
                                        <label className='mb-2.5 block font-medium text-black dark:text-white'>
                                            Display Name
                                    ...
                                    <div className='mb-4'>
                                        ...
                                        <input
                                            ...
                                            className={`w-full rounded-lg border border-stroke bg-transparent py-4 pl-6 pr-10 outline-none focus:border-primary focus-visible:shadow-none dark:border-form-strokedark dark:bg-form-input dark:focus:border-primary ${errors['email'] ? 'border-danger' : ''}`}
                                        />
                                        {errors && <div className="text-danger p-2">{errors['email']}</div>}
                                    </div>
                                    ...
                                    <div className='mb-6'>
                                        ...
                                        <input
                                            ...
                                            className={`w-full rounded-lg border border-stroke bg-transparent py-4 pl-6 pr-10 outline-none focus:border-primary focus-visible:shadow-none dark:border-form-strokedark dark:bg-form-input dark:focus:border-primary ${errors['password'] ? 'border-danger' : ''}`}
                                        />
                                        {errors && <div className="text-danger p-2">{errors['password']}</div>}
                                    </div>
                                    ...
                                    <div className='mb-6'>
                                        ...
                                        />
                                        {errors &&
                                            <div className="text-danger p-2">{errors['password_confirmation']}</div>}
                                    </div>
