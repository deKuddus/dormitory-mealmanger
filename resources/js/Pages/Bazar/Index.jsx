        ...
        return (
            <div>
                ...
                <div className="flex items-center justify-end mb-6">
                    {isUserPermittedToPerformAction('access::bazar-create', user_permissions) && <Link
                                    ...
                                    >
                                        ...
                                        <td className="w-px border px-4 py-3 whitespace-nowrap">
                                            <div className="flex items-center gap-4 justify-end">
                                                {status === 0 && isUserPermittedToPerformAction('access::bazar-approve', user_permissions) &&
                                                    <button
                                                ...
                                                {status !== 2 ? (
                                                    <>
                                                        {isUserPermittedToPerformAction('access::bazar-edit', user_permissions) &&
                                                            <Link
                                                        ...
                                                        {isUserPermittedToPerformAction('access::bazar-delete', user_permissions) &&
                                                            <button
