...
const Index = () => {
    const {
        bazar, bazarTotal, additionalCost, additionalCostTotal, alltimeAdditonalCost, alltimeBazar, deposit, flash,
    } = usePage().props;

    return (<div>
        <BreadcrumbForTable
            name={`All time Balance: ${deposit} BDT and All time Expense ${alltimeBazar + alltimeAdditonalCost}`}
            link={''} text={''} isShowButton={false}/>
        <div
                ...
                <div className="grid gap-4 lg:gap-8 grid-cols-1 md:grid-cols-2 lg:grid-cols-2">
                    <div className="flex flex-col">
                        ...
                        <table className="w-full table-auto">
                            ...
                            </tr>))) : (<tr className="hover:bg-gray-100 focus-within:bg-gray-100">
                    ...
                    <div className="flex flex-col">
                        ...
                        <table className="w-full table-auto">
                            <TableHeader rows={['No', 'Amount', 'Date', 'Note']}/>
                            <tbody>
                            {additionalCost.length ? (additionalCost.map(({
                                                                              id, amount, created_at, description,
                                                                          }, key) => (<tr key={key}>
                                <TableData value={key + 1}/>
                                <TableData value={amount}/>
