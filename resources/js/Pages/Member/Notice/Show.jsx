    ...
    return (
        <>
            ...
            <div className="overflow-x-auto bg-white rounded shadow p-3">
                <h2 className="text-xl p-4 border-b-2">Title: {notice.title}</h2>
                <p className="mb-3 p-4 leading-8 font-light text-gray-500" dangerouslySetInnerHTML={{ __html: notice.description }} />
            </div>
        </>
    );
};
